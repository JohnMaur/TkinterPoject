from tkinter import Frame, Label, Entry, Checkbutton, Button, BooleanVar, CENTER
...
class SignUpView(Frame):
    def __init__(self, *args, **kwargs):
        ...
        self.confirm_password_input = Entry(self, show="*")
        self.confirm_password_label.grid(row=3, column=0, padx=10, sticky="w")
        self.confirm_password_input.grid(row=3, column=1, padx=(0, 20), sticky="ew")
